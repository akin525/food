                ...
                <div class="col-md-3">
                    <form id="cat">
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" name="label" placeholder="Type here" class="form-control" id="label">
                        </div>
                        <div class="mb-8">
...
{{--                        </div>--}}
                        <div class="d-grid">
                            <button class="btn btn-primary">Create Color</button>
                        </div>
                    </form>
                </div>
                <div class="col-md-9">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle table-nowrap mb-0 table-borderless"><thead class="table-light">
                                <tr>
                                    ...
                                    <th class="align-middle" scope="col">Color
                                    </th>
                                    <th class="align-middle text-center" scope="col">Actions
                                    </th>
                                </tr>
                                </thead><tbody>
                                @forelse($color as $cat)
                                <tr>
                                    ...
                                    <td class="text-body-emphasis">{{$cat['label']}}</td>
                                    <td class="text-body-emphasis">
                                        <input type="color" value="{{$cat['name']}}"/>
                                    </td>
                                    <td class="text-center">
                                ...
                                <div class="modal-content">
                                    <form id="dataForm" >
                                        ...
                                        <div class="card card-body">
                                            ...
                                            <p class="text-center" >EDIT Layers</p>
                                            </div>
